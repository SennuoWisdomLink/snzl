...
export default function About() {
  ...
  return (
    <section id="about" className="py-12 sm:py-20 bg-secondary" ref={aboutRef}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* 用Flex容器实现「图左文右」布局，大屏幕分栏/移动端堆叠 */}
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          {/* 图片区域：占全屏宽度，大屏幕下占1/2 */}
          <div className="relative w-full lg:w-1/2 aspect-[4/3] sm:aspect-[3/2] lg:aspect-[16/9]">
            <Image
          ...
          <div className="w-full lg:w-1/2 animate-on-scroll">
            ...
            <p className="text-gray-300 mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">
              作为高新技术产业的重要参与者，森诺智联嘉始终以技术创新为引擎，以产业需求为导向，深度与高校、科研院所、产业伙伴合作，加速技术成果转化，致力于成为智能机器人领域 “产学研用” 协同创新的典范，为推动产业智能化升级贡献核心技术力量。
            </p>
          </div>
        </div>
      </div>
